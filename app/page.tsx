  ...
  return (
    <>
      ...
      <Container className="relative h-screen z-10 max-w-7xl mx-auto px-4 border-x border-border w-full">
        <Navbar />
        {/* HERO TEXT */}
        <div className="pt-8 sm:pt-12 md:pt-16 pb-4 sm:pb-8 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-geist-pixel-square text-center">
          <h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            ...
            <Link href="/tools">
              <Button
                ...
                className="w-full sm:w-auto px-8 py-6 text-md font-geist-pixel-square font-medium relative z-10"
              >
                Explore Tools
              </Button>
            </Link>
